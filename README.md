...
- Montants du tirage aléatoire (1er et 2e paiements du jour) : dans `db.js`, fonction `computeNextAmount` (`[1, 2, 3]`).
- Seuil "à partir du 3e paiement" : même fonction, condition `already < 2`.
